...
export default function Home() {
  const [stream, setCaptureStream] = useState<MediaStream | null>(null);
            ...
            <div className="flex-1 overflow-auto p-4">
              ...
              <div className="flex items-start gap-4 mt-6">
                ...
                <div className="grid gap-1">
                  ...
                  <div className="prose text-muted-foreground">
                    <p>
                      Hi ChatGPT! I'm interested in learning more about the
                      latest advancements in AI technology. Can you tell me
                      about some of the exciting developments happening in the
                      field?
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-4 mt-6">
                ...
                <div className="grid gap-1">
                  ...
                  <div className="prose text-muted-foreground">
                    <p>
                      Absolutely! There have been some incredible advancements
                      in AI technology recently. One of the most exciting
                    ...
                    <p>
                      ...
                      understand visual information with human-like accuracy.
                      This has opened up a wide range of applications, from
                      autonomous vehicles to medical image analysis.
                    </p>
                    <p>
                      Additionally, the increasing availability of large
                      datasets and the growing computational power of modern
                      hardware have allowed for the development of more
                      sophisticated and capable AI models. These advancements
                      are paving the way for AI to tackle increasingly complex
                      problems and provide valuable insights across a variety of
                      industries.
                    </p>
                  </div>
                </div>
