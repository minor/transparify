...
export async function POST(request: Request) {
    ...
    const options = {
        ...
        body: `{"query":"fact check this statement: '${statement}' Answer in two or three very short sentances. If the statement is correct, give a one word response: 'correct'. If the statement is too vague, response with 'vague'."}`
    };
